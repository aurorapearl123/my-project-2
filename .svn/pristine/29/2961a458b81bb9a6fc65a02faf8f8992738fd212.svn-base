...
class Clothes_category extends CI_Controller
{
    //Default Variables
    var $menu;
    var $roles;
    ...
    public function __construct()
    {
        ...
        $this->data['controller_page']  = $this->controller_page = site_url('clothes_category');// defines contoller link
        $this->table        = 'clothes_categories';                                                  // defines the default table
        $this->pfield = $this->data['pfield'] = 'clothesCatID';                                                 // defines primary key
        // $this->logfield     = 'deptCode';
        $this->module_path  = 'modules/'.strtolower(str_replace(" ","_",$this->module)).'/clothes_category';             // defines module path
    ...
    private function submenu()
    {
        ...
        $this->data['current_module']        = $this->modules[$this->module]['sub']['Clothes Category'];      // defines the current sub module
        // check roles
        $this->check_roles();
    ...
    public function save()
    {
        ...
        if ($this->roles['create']) {
            ...
            if ($this->record->save()) {
                $this->record->fields = array();
                $clothesCatID = $this->record->where['clothesCatID'] = $this->db->insert_id();
                ...
                $data["urlredirect"] = $this->controller_page."/view/".$this->encrypter->encode($clothesCatID);
                $this->load->view("header",$data);
                $this->load->view("message");
                $this->load->view("footer");
    ...
    public function update()
    {
        ...
        $this->submenu();
        $data = $this->data;
        $table_fields = array('category','status');
    ...
    public function printlist()
    {
        ...
        $data['title'] = "Clothes Category List";
    ...
    {
        $this->db->where('clothesCatID', trim($this->input->post('clothesCatID')));      
