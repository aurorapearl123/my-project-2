...
class Incentive_type extends CI_Controller
{
    //Default Variables
    var $menu;
    var $roles;
    ...
    public function __construct()
    {
        ...
        $this->table        = 'incentive_types';                                                 
        $this->pfield       = $this->data['pfield'] = 'incentiveTypeID';                                                 
        $this->logfield     = 'code';
        $this->module_path  = 'modules/salary_and_wages/incentive_type';           
        $this->data['controller_page']  = $this->controller_page = site_url('incentive_type');
    ...
    private function submenu()
    {
        ...
        $this->data['current_module']   = $this->modules[$this->module]['sub']['Incentive Type'];      // defines the current sub module
        // check roles
        $this->check_roles();
    ...
    public function save()
    {
        ...
        $this->submenu();
        $data = $this->data;
        $table_fields = array('code','name','abbr','isTaxable','isBasic','remarks','status');
    ...
    {
        $tables = array('incentives'=>'incentiveTypeID');
