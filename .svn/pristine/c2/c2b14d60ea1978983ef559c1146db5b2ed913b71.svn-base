...
class Supplier extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->data['controller_page']  = $this->controller_page = site_url('supplier');// defines contoller link
        $this->table        = 'suppliers';                                                  // defines the default table
        $this->pfield = $this->data['pfield'] = 'supplierID';                                                 // defines primary key
        // $this->logfield     = 'deptCode';
        $this->module_path  = 'modules/'.strtolower(str_replace(" ","_",$this->module)).'/supplier';             // defines module path
    ...
    private function submenu()
    {
        ...
        $this->data['current_module']        = $this->modules[$this->module]['sub']['Suppliers'];      // defines the current sub module
        // check roles
        $this->check_roles();
    ...
    public function save()
    {
        ...
        $this->submenu();
        $data = $this->data;
        $table_fields = array('name','location','contactNo');
        ...
        if ($this->roles['create']) {
            ...
            if ($this->record->save()) {
                $this->record->fields = array();
                $supplierID = $this->record->where['supplierID'] = $this->db->insert_id();
                ...
                $data["urlredirect"] = $this->controller_page."/view/".$this->encrypter->encode($supplierID);
                $this->load->view("header",$data);
                $this->load->view("message");
                $this->load->view("footer");
    ...
    public function update()
    {
        ...
        $this->submenu();
        $data = $this->data;
        $table_fields = array('name','location','contactNo','status');
    ...
    {
        $this->db->where('supplierID', trim($this->input->post('supplierID')));      
