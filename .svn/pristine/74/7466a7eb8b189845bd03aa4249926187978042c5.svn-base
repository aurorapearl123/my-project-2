            ...
            <div class="data-view">
              <table class="view-table">
                <tbody>
                  ...
                  <tr>
                    <td>Date washed : &nbsp;&nbsp;<span><?php echo $rec->dateCreated;?></span></td>
                  </tr>
                  <tr>
                    <td>Date Ready : &nbsp;&nbsp;<span><?php echo $rec->dateCreated;?></span></td>
                  </tr>
                  <tr>
                    <td>Cancelled by : &nbsp;&nbsp;<span><?php echo $rec->firstName .' '.$rec->middleName.' '.$rec->lastName;?></span></td>
                  </tr>
                  <tr>
                    <td>Date Fold : &nbsp;&nbsp;<span><?php echo $rec->dateCreated;?></span></td>
                  </tr>
                  <tr>
                    <td>Date Released : &nbsp;&nbsp;<span><?php echo $rec->dateCreated;?></span></td>
                  </tr>
                </tbody>
              </table>
            </div>
...
<script>
  $(document).ready(function(){
      ...
      $('#ready_proceed').on('click', function(){
