<div class="subheader">
	<div class="d-flex align-items-center">
		...
		<div class="subheader-tools">
			<a href="<?php echo site_url('expense_particular/show') ?>" class="btn btn-primary btn-raised btn-xs pill"><i class="icon ti-angle-left"></i> Back to List</a>
		</div>
	</div>
</div>
<div class="content">
				...
				<div class="card-body">
					<div class="data-view">
						<table class="view-table">
							<tbody>
								<tr>
									<td class="data-title" nowrap>Particular:</td>
									<td class="data-input"><?php echo $rec->particular; ?></td>
									<td class="data-title"></td>
									<td></td>
								</tr>
								<tr>
									<td class="data-title" style="width:120px" nowrap>Description</td>
									<td class="data-input" style="width:420px" nowrap><?php echo $rec->description; ?></td>
									<td class="data-title"></td>
									<td></td>
								</tr>
