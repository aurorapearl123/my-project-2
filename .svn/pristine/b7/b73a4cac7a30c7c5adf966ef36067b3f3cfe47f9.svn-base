								...
								<table class="table table-striped hover">
									<thead>
										<tr class="thead-light">
											<?php 
												$headers = array(												    
												    array('column_header'=>'EXP No','column_field'=>'expNo','width'=>'w-5','align'=>''),
												    array('column_header'=>'Date','column_field'=>'date','width'=>'w-5','align'=>''),
												    array('column_header'=>'Branch Name','column_field'=>'branchName','width'=>'w-5','align'=>'center'),
										...
										<tr id="filter-group" class="collapse multi-collapse show">
											...
											<th class="form-group form-input">
												<input type="text" class="form-control w-80" id="expNo" name="expNo" value="<?php echo $expNo ?>">
											</th>	
											<th class="form-group form-input">
											...
											<th class="form-group form-input">
												<input type="text" class="form-control w-60" id="branchName" name="branchName" value="<?php echo $branchName ?>">
											</th>	
