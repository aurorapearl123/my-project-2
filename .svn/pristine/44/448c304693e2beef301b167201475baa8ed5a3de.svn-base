	...
	<div class="row">
		<div class="col-12">
			<div class="card-box">
				...
				<div class="card-body">
					<form method="post" name="frmEntry" id="frmEntry" action="<?php echo site_url("section/save") ?>">
						<div class="table-row">
								...
								<tbody>
									<tr>
										...
										<td class="form-group form-input">
											<input type="text" class="form-control" name="divisionCode" id="divisionCode" title="Division Code" required>
										</td>
									...
									<tr>
										...
										<td class="form-group form-input" style="width:350px" nowrap>
											<input type="text" class="form-control" name="divisionName" id="divisionName"  title="Section Name" required>
										</td>
									...
									<tr>
										<td class="form-label align-text-top pt-5" nowrap>Section Head </td>
										<td class="form-group form-input">
											<?php 
										...
										<td class="form-label align-text-top pt-5" nowrap>Head Title </td>
										<td class="form-group form-input">
											<input type="text" class="form-control" name="divisionHeadTitle" id="divisionHeadTitle" value="<?php echo $rec->divisionHeadTitle?>">
										</td>
										<td class="d-xxl-none"></td>
									</tr>
									<tr>
