								...
								<table class="table table-striped has-img hover">
									<thead>
										<tr>
											<?php 
												$headers = array(												    
												    array('column_header'=>'Name','column_field'=>'name','width'=>'w-25','align'=>''),
												    array('column_header'=>'Location','column_field'=>'location','width'=>'w-25','align'=>''),
											      	array('column_header'=>'Contact No','column_field'=>'location','width'=>'w-20','align'=>''),
										...
										<tr id="filter-group" class="collapse multi-collapse table-filter show">
											<th class="form-group form-input">
												<input type="text" class="form-control" id="name" name="name" style="width:300px" value="<?php echo $name ?>">
											</th>
											<th class="form-group form-input">
												<input type="text" class="form-control" id="location" name="location" style="width:300px" value="<?php echo $location ?>">
											</th>
											<th class="form-group form-input">
											 &nbsp;
											</th>
									...
									<tbody>
										<?php 
											if (count($records)) {
											    ...
											    ?>
										<tr onclick="location.href='<?php echo $controller_page."/view/".$this->encrypter->encode($row->supplierID); ?>'">
