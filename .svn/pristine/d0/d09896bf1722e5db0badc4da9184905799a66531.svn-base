...
class Attendance extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->data['controller_page']  = $this->controller_page = site_url('attendance');		// defines contoller link
        $this->table        = 'shift_schedules';                                                  	// defines the default table
        $this->pfield = $this->data['pfield'] = 'shiftScheduleID';                                	// defines primary key
        $this->logfield     = 'empID';
        $this->module_path  = 'modules/'.strtolower(str_replace(" ","_",$this->module)).'/attendance'; // defines module path
    ...
    private function submenu()
    {
        ...
        $this->data['current_module']        = $this->modules[$this->module]['sub']['Attendance'];      // defines the current sub module
        // check roles
        $this->check_roles();
