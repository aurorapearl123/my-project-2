...
class Contribution extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->table        = 'contribution_details';                                                 
        $this->pfield       = $this->data['pfield'] = 'detailID';                                                 
        $this->logfield     = 'employmentID';
        $this->module_path  = 'modules/salary_and_wages/contribution';           
        $this->data['controller_page']  = $this->controller_page = site_url('contribution');
    ...
    private function submenu()
    {
        ...
        $this->data['current_module']   = $this->modules[$this->module]['sub']['Contribution'];      // defines the current sub module
        // check roles
        $this->check_roles();
    ...
    public function save()
    {
        ...
        $this->submenu();
        $data = $this->data;
        $table_fields = array('employmentID','employeeShare','employerShare','isAutomatic','isPayment','remarks');
        ...
        if ($this->roles['create']) {
            ...
            if (!empty($employment)) {
                $this->db->set('premiumID', trim($this->input->post('premiumID')));
    ...
    public function edit($id)
    {
        ...
        if ($this->roles['edit']) {
            ...
            $this->records->fields[] = 'contributions.premiumID';
            $this->records->joins[]  = array('contributions',$this->table.'.payID=contributions.payID','left');
            // set where
    ...
    public function update()
    {
        ...
        $this->submenu();
        $data = $this->data;
        $table_fields = array('employeeShare','employerShare','isAutomatic','isPayment','remarks','status');
    ...
    public function view($id)
    {
        ...
        if ($this->roles['view']) {
            ...
            $this->db->join('contributions', $this->table.'.payID=contributions.payID', 'left');
    ...
    public function show()
    {
        ...
        $condition_fields = array(
			...
			array('variable'=>'premiumID', 'field'=>'contributions.premiumID', 'default_value'=>'', 'operator'=>'where'),
    ...
    function exportlist()
    {
        ...
        $data = "<?xml version='1.0'?>
    		...
    		<Column ss:Index='11' ss:AutoFitWidth=\"1\" ss:Width='150.00'/>
        ...
        if (count($records)) {
            ...
            foreach ($records as $row) {
                ...
                $data .= "<Cell ss:StyleID='s27'><Data ss:Type='Number'>".$row->employeeShare."</Data></Cell>";
                $data .= "<Cell ss:StyleID='s27'><Data ss:Type='Number'>".$row->employerShare."</Data></Cell>";
    ...
    {
        $tables = array('payslip_contributions'=>'payID');
