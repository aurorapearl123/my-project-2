<div class="subheader">
	<div class="d-flex align-items-center">
		...
		<div class="subheader-tools">
			<a href="<?php echo site_url('customer/show') ?>" class="btn btn-primary btn-raised btn-xs pill"><i class="icon ti-angle-left"></i> Back to List</a>
		</div>
	</div>
</div>
<div class="content">
				...
				<div class="card-body">
					<div class="data-view">
						<table class="view-table">
							<tbody>
								<tr>
									<td class="data-title" nowrap>Title:</td>
									<td class="data-input" nowrap><?php echo $rec->title; ?></td>
									<td colspan="3"></td>
								</tr>
								<tr>
									<td class="data-title" style="width:120px" nowrap>Suffix:</td>
									<td class="data-input" style="width:320px" nowrap><?php echo $rec->suffix; ?></td>
									<td class="data-title" style="width:120px" nowrap>First Name:</td>
									<td class="data-input" style="width:320px" nowrap><?php echo $rec->fname; ?></td>
									<td></td>
								</tr>
								<tr>
