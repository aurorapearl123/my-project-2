                    ...
                    if (!empty($subcon['roles'])) {
                      foreach($subcon['roles'] as $role) {
                        ...
                        <div class="checkbox" style="padding-bottom: 10px; font-weight: bold;" nowrap>
                          <label style="font-weight: bold;"><input type="checkbox" class="<?php echo strtolower(str_replace(" ", "_", $sub)) ?>" name="roles[]" value="<?php echo $role ?>" <?php if (in_array($role, $roles)) echo "checked"  ?> disabled/> <?php echo $role ?></label><br/>
                        </div>
                        <?php 
                      }
                    }
