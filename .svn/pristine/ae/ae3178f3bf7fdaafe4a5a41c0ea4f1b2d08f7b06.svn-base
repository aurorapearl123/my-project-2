									...
									<thead>
										<tr>
											<?php 
												$headers = array(
												    ...
												    array('column_header'=>'Supplier','column_field'=>'companyEmail','width'=>'w-10','align'=>''),
												    array('column_header'=>'Total Amount','column_field'=>'companyAddress','width'=>'w-15','align'=>''),
												    array('column_header'=>'Crated By','column_field'=>'companyHeadID','width'=>'w-15','align'=>''),
										...
										<tr id="filter-group" class="collapse multi-collapse table-filter show">
											<th class="form-group form-input">
												<input type="text" class="form-control" id="lname" name="lname" style="width:150px" value="<?php echo $date ?>">
											</th>
											<th class="form-group form-input">
									...
									<tbody>
										<?php 
											if (count($records)) {
											    ...
											    ?>
										<tr onclick="location.href='<?php echo $controller_page."/view/".$this->encrypter->encode($row->rrID); ?>'">
