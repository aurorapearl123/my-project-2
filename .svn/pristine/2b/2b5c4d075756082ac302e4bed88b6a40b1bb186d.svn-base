...
class Work_experience extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        // set variables
        $this->data['current_module'] = $this->module = 'Work Experience';
        $this->module_label = 'Work Experiences';
        $this->table        = 'employee_work_experiences';
        $this->module_path  = 'modules/Employee/Work_Experience';
        $this->module_path_submenu  = 'modules/Employee/submenu';
        $this->pfield = 'workID';
        $this->logfield = 'designation';
        $this->data['controller_page'] = $this->controller_page = site_url('work_experience');
    ...
    public function create()
    {
        ...
        if ($this->roles['create']) {
            $data['required_fields'] = array('empID'=>'Employee', 'type'=>'Type','designation'=>'Designation','company'=>'Company');
    ...
    public function save()
    {
        ...
        if ($this->roles['create']) {
            ...
            $table_fields = array('empID', 'type', 'designation', 'company', 'employment','basicSalary', 'salaryType','startYear','startMonth','startDay',
            ...
            if ($this->record->save()) {
                ...
                $this->record->where['company']     = trim($this->input->post('company'));
                $this->record->where['employment']  = trim($this->input->post('employment'));
    ...
    {
        $this->db->order_by('work_experience','asc');
        $records = $this->db->get('work_experiences');
        echo $this->frameworkhelper->get_json_data($records, 'workID', 'designation');
    }
