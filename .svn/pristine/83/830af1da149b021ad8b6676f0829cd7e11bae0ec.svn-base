...
class Skill extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        // set variables
        $this->data['current_module'] = $this->module = 'Special Skill';
        $this->module_label = 'Special Skills';
        $this->table        = 'employee_skills';
        $this->module_path  = 'modules/Employee/Skill';
        $this->module_path_submenu  = 'modules/Employee/submenu';
        $this->pfield = 'skillID';
        $this->logfield = 'skill';
        $this->data['controller_page'] = $this->controller_page = site_url('skill');
    ...
    public function save()
    {
        ...
        if ($this->roles['create']) {
            ...
            $table_fields = array('empID', 'skill', 'yearsExp', 'remarks');
            ...
            if ($this->record->save()) {
                ...
                $this->record->where['skill']       = trim($this->input->post('skill'));                
    ...
    public function show()
    {
        ...
        //Setup list
        $data['records'] = $this->db->get('skills');
        //load views
        $this->load->view('header', $data);
    ...
    public function get_skills()
    {
        ...
        //mag gamit ta aning get_json_data? 
        echo $this->frameworkhelper->get_json_data($records, 'skillID', 'skill');
    }
