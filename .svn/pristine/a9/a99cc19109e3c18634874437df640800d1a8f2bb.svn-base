...
class Equipment extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->data['controller_page']  = $this->controller_page = site_url('equipment');// defines contoller link
        $this->table        = 'equipments';                                                  // defines the default table
        $this->pfield = $this->data['pfield'] = 'equipmentID';                                                 // defines primary key
        // $this->logfield     = 'deptCode';
        $this->module_path  = 'modules/'.strtolower(str_replace(" ","_",$this->module)).'/equipment';// defines module path / folder name
    ...
    private function submenu()
    {
        ...
        $this->data['current_module']        = $this->modules[$this->module]['sub']['Equipments'];      // defines the current sub module
        // check roles
        $this->check_roles();
    ...
    public function save()
    {
        ...
        $this->submenu();
        $data = $this->data;
        $table_fields = array('brand','model','serialNo','name','description');
        ...
        if ($this->roles['create']) {
            ...
            if ($this->record->save()) {
                $this->record->fields = array();
                $equipmentID = $this->record->where['equipmentID'] = $this->db->insert_id();
                ...
                $data["urlredirect"] = $this->controller_page."/view/".$this->encrypter->encode($equipmentID);
                $this->load->view("header",$data);
                $this->load->view("message");
                $this->load->view("footer");
    ...
    public function update()
    {
        ...
        $this->submenu();
        $data = $this->data;
        $table_fields = array('brand','model','serialNo','name','description','status');
    ...
    public function show()
    {
        ...
        $condition_fields = array(
            ...
            array('variable'=>'model', 'field'=>$this->table.'.model', 'default_value'=>'', 'operator'=>'like_both'),
            array('variable'=>'serialNo', 'field'=>$this->table.'.serialNo', 'default_value'=>'', 'operator'=>'like_both'),
