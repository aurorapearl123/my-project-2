          ...
          <input type="hidden" name="<?php echo $pfield?>" id="<?php echo $pfield?>" value="<?php echo $this->encrypter->encode($rec->$pfield) ?>" />
            <div class="subtitle">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td class="form-group form-input">
                                <input type="text" class="form-control" id="empNo" name="empNo" value="<?php echo $rec->empNo?>" title="ID Number" required>
                              </td>
                              <td colspan="4"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              ...
                              <td class="form-group form-input" width="21.33%">
                                <select id="bloodType" name="bloodType" class="form-control">
                                  <option value="A+"  <?php echo ($rec->bloodType == 'A+') ? 'selected' : ''?>>A+</option>
                                  <option value="A-" <?php echo ($rec->bloodType == 'A-') ? 'selected' : ''?>>A-</option>
                                  <option value="B+" <?php echo ($rec->bloodType == 'B+') ? 'selected' : ''?>>+</option>
                                  <option value="B-" <?php echo ($rec->bloodType == 'B-') ? 'selected' : ''?>>B-</option>
                                  <option value="AB+" <?php echo ($rec->bloodType == 'AB+') ? 'selected' : ''?>>AB+</option>
                                  <option value="AB-" <?php echo ($rec->bloodType == 'AB-') ? 'selected' : ''?>>AB-</option>
                                  <option value="O+" <?php echo ($rec->bloodType == 'O+') ? 'selected' : ''?>>O+</option>
                                  <option value="O-" <?php echo ($rec->bloodType == 'O-') ? 'selected' : ''?>>O-</option>
                                </select>
                              </td>
                              <td class="form-label" width="12%">
                              ...
                              <td class="form-group form-input" width="">
                                <input type="text" class="form-control" id="weight" name="weight" value="<?php echo $rec->weight?>">
                              </td>
                              <td class="form-label" width="12%">
                                <label for="height">Height</label>
                              </td>
                              <td class="form-group form-input" width="">
                                <input type="text" class="form-control" id="height" name="height" value="<?php echo $rec->height?>">
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td class="form-group form-input" colspan="5">
                                <textarea class="form-control" id="medicalCondition" name="medicalCondition"><?php echo $rec->medicalCondition?></textarea>
                              </td>
                            </tr>
                            <tr>
                              <td class="form-label align-text-top pt-5">
                              ...
                              <td class="form-group form-input" colspan="5">
                                <textarea class="form-control" id="medicalHistory" name="medicalHistory"><?php echo $rec->medicalHistory?></textarea>
                              </td>
                            </tr>
                          </tbody>
                        </table>
                        ...
                        <table class="table-form">
                          <tbody>
                            <tr>
                              ...
                              <td class="form-group form-input" width="">
                                <textarea class="form-control" id="recommendedBy" name="recommendedBy"><?php echo $rec->recommendedBy?></textarea>
                              </td>
                            </tr>
                          </tbody>
                        </table>
                      ...
                      <div class="form-group mb-0">
                        <button type="submit" class="btn btn-primary btn-raised pill" name="cmdSave" id="cmdSave">Save</button>
