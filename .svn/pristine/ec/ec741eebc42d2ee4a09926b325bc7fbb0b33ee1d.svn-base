					...
					<form method="post" name="frmEntry" id="frmEntry" action="<?php echo site_url('customer/update') ?>">
						...
						<div class="table-row">
                            <table class="table-form column-3">
                                <tbody>
                                <tr>
                                    <td class="form-label" style="width:12%" nowrap>Title<span class="asterisk">*</span></td>
                                    ...
                                    <td class="form-label" style="width:12%" nowrap>Suffix<span class="asterisk">*</span></td>
                                    <td class="form-group form-input" style="width:21.33%" nowrap>
                                ...
                                <tr>
                                    ...
                                    <td class="form-label" nowrap>First Name <span class="asterisk">*</span></td>
                                    <td class="form-group form-input">
                                        <input type="text" class="form-control" name="fname" id="fname" title="First Name" value="<?php echo $rec->fname?>" required>
                                    </td>

                                    <td class="form-label" nowrap>Middle Name <span class="asterisk">*</span></td>
                                    <td class="form-group form-input">
                                ...
                                <tr>
                                    <td class="form-label" style="width:12%" nowrap>Last Name <span class="asterisk">*</span></td>
                                    ...
                                    <td class="form-label" style="width:12%" nowrap>Birth Date <span class="asterisk">*</span></td>
                                    <td class="form-group form-input" style="width:21.33%">
                                ...
                                <tr>
                                    ...
                                    <td class="form-label" style="width:12%" nowrap>Regular <span class="asterisk">*</span></td>
                                    <td class="form-group form-input" style="width:21.33%">
                                ...
                                <tr>
                                    <td class="form-label" nowrap>Mobile <span class="asterisk">*</span></td>
                                    <td class="form-group form-input">
