...
class Department extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->data['controller_page']  = $this->controller_page = site_url('department');// defines contoller link
        $this->table        = 'departments';                                                  // defines the default table
        $this->pfield = $this->data['pfield'] = 'deptID';                                                 // defines primary key
        $this->logfield     = 'deptCode';
        $this->module_path  = 'modules/'.strtolower(str_replace(" ","_",$this->module)).'/department';             // defines module path
    ...
    private function submenu()
    {
        ...
        $this->data['current_module']        = $this->modules[$this->module]['sub']['Department'];      // defines the current sub module
        // check roles
        $this->check_roles();
    ...
    public function save()
    {
        ...
        $this->submenu();
        $data = $this->data;
        $table_fields = array('companyID','branchID','deptCode','deptName','deptHead','deptTitle');
        ...
        if ($this->roles['create']) {
            ...
            if ($this->record->save()) {
                $this->record->fields = array();
                $deptID = $this->record->where['deptID'] = $this->db->insert_id();
                ...
                $data["urlredirect"] = $this->controller_page."/view/".$this->encrypter->encode($deptID);
                $this->load->view("header",$data);
                $this->load->view("message");
                $this->load->view("footer");
    ...
    public function update()
    {
        ...
        $this->submenu();
        $data = $this->data;
        $table_fields = array('companyID','branchID','deptCode','deptName','deptHead','deptTitle','status');
