								...
								<tbody>
									<tr>
										...
										<td class="form-group form-input">
											<input type="text" class="form-control" name="name" id="name" value="<?php echo $rec->name?>" title="Supplier Name" required>
										</td>										
									...
									<tr>
										<td class="form-label" nowrap>Contact Number<span class="asterisk">*</span></td>
										<td class="form-group form-input">
											<input type="text" class="form-control" name="contactNo" id="contactNo" value="<?php echo $rec->contactNo ?>" title="Contact Number" required>
										</td>										
										<td class="d-xxl-none" colspan="2"></td>
									</tr>
									<tr>
