...
class Complaint extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->data['controller_page']  = $this->controller_page = site_url('complaint');// defines contoller link
        $this->table        = 'complaints';                                                  // defines the default table
        $this->pfield = $this->data['pfield'] = 'comID';                                                 // defines primary key
        // $this->logfield     = 'deptCode';
        $this->module_path  = 'modules/'.strtolower(str_replace(" ","_",$this->module)).'/complaint';// defines module path / folder name
    ...
    private function submenu()
    {
        ...
        $this->data['current_module']        = $this->modules[$this->module]['sub']['Complaints'];      // defines the current sub module
        // check roles
        $this->check_roles();
    ...
    public function save()
    {
        ...
        $this->submenu();
        $data = $this->data;
        $table_fields = array('branchID','custID','orderID','complaint','contactNo','createdBy');
        ...
        if ($this->roles['create']) {
            ...
            if ($this->record->save()) {
            	$this->record->fields = array();
                $comID = $this->record->where['comID'] = $this->db->insert_id();
                ...
                $data["urlredirect"] = $this->controller_page."/view/".$this->encrypter->encode($comID);
                $this->load->view("header",$data);
                $this->load->view("message");
                $this->load->view("footer");
    ...
    public function edit($id)
    {
        ...
        if ($this->roles['edit']) {
            ...
            $this->record->fields[] = 'service_types.serviceType';    
       		// set joins
       		...
       		$this->record->joins[]	= array('order_headers',$this->table.'.orderID=order_headers.orderID','left');
            $this->record->joins[]  = array('service_types','order_headers.serviceID=service_types.serviceID','left');
            // set where
    ...
    public function update()
    {
        ...
        $this->submenu();
        $data = $this->data;
        $table_fields = array('branchID	','custID','orderID','complaint','contactNo','createdBy','status');
    ...
    public function confirm($id)
    {
        ...
        $this->submenu();
        $data = $this->data;
        $table_fields = array('confirmedBy ','dateConfirmed');
        ...
        if ($this->roles['edit']) {
            ...
            $this->record->fields['confirmedBy']      =   $this->session->userdata('current_user')->userID;
            $this->record->fields['dateConfirmed']    =   date('Y-m-d H:i:s');
    ...
    public function cancel($id)
    {
        ...
        if ($this->roles['edit']) {
            ...
            $this->record->fields['cancelledBy']      =   $this->session->userdata('current_user')->userID;
            $this->record->fields['dateCancelled']    =   date('Y-m-d H:i:s');
    ...
    public function view($id)
    {
        ...
        if ($this->roles['view']) {
            ...
            $this->record->joins[]  = array('users as confirmedByUser',$this->table.'.confirmedBy=confirmedByUser.userID','left');
