...
class Withdrawal_slip extends CI_Controller {
    ...
    public function save() {
        ...
        $table_fields = array ('date', 'branchID','withdrawnedBy', 'remarks','createdBy');
        ...
        if ($this->roles ['create']) {
            ...
            $wsSeries= $this->db->get('seriesno')->row();
            
            $wsSeriesNo = $wsSeries->wsNo + 1;
            
            require_once(APPPATH.'controllers/Generic_ajax.php');
            $seriesNo = Generic_ajax::updateSeriesNo('wsNo',$wsSeriesNo,$userCurrentBranch);

            $this->records->fields['wsNo']           =   str_pad($wsSeriesNo,4,'0',STR_PAD_LEFT);
...
public function show() {
        ...
        $condition_fields = array (
            array ('variable' => 'wsNo', 'field' => $this->table . '.wsNo', 'default_value' => '', 'operator' => 'like_both' ), 
            ...
            array ('variable' => 'lastName', 'field' => 'users.lastName', 'default_value' => '', 'operator' => 'like_both' ), 
        ...
        // // sorting fields
        $sorting_fields = array ('wsNo' => 'desc' );
    ...
    public function check_duplicate() {
        ...
        $this->db->where ( 'withdrawnedBy', trim ( $this->input->post ( 'withdrawnedBy' ) ) );
    ...
    public function addStockCard()
    {
        ...
        $reference_no = '0000'.$row_series->wsNo;
    ...
    public function updateApprovedBy()
    {
        ...
        require_once(APPPATH.'controllers/Generic_ajax.php');
        //update approved by        
        $approvedBy = Generic_ajax::updateApprovedBy($this->table, "wsID", $wsID, $this->session->userdata('current_user')->userID);
        $response = [
            'data' => [
                'status' => 200,                
                'approvedBy' => $approvedBy
 ...
 
    {
        ...
        //update approved by
        //updateApproveBy($table, $compareId, $id, $approvedBy)
        $approvedBy = Generic_ajax::updateCancelledBy($this->table, "wsID",  $wsID, $this->session->userdata('current_user')->userID);
