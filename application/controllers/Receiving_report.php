...
//            $data['items'] = $items;
    ...
    public function save() {
        ...
        $table_fields = array ('date', 'branchID', 'suppID', 'ttlQty','ttlAmount','createdBy', 'referenceNo');
        ...
        if ($this->roles['create']) {
            ...
            $rrSeriesNo = $adjSeries->rrNo + 1;
            
            require_once(APPPATH.'controllers/Generic_ajax.php');
            $seriesNo = Generic_ajax::updateSeriesNo('rrNo',$rrSeriesNo,$userCurrentBranch);

            $this->records->fields['rrNo']           =   str_pad($rrSeriesNo,4,'0',STR_PAD_LEFT);
            ...
            if ($this->records->save ()) {
                ...
                $this->insert_receiving_details($id, $items_ids, $qtys, $amounts);
    ...
    public function show() {
        ...
        $condition_fields = array (
            ...
            array ('variable' => 'name', 'field' =>  'suppliers.name', 'default_value' => '', 'operator' => 'like_both' ), 
            array ('variable' => 'ttlQty', 'field' => $this->table . '.ttlQty', 'default_value' => '', 'operator' => 'where' ),
    ...
    public function check_duplicate()
    {
        ...
        $this->db->where('suppID', trim($this->input->post('suppID')));      
        $this->db->where('referenceNo', trim($this->input->post('referenceNo')));      
    ...
    public function insert_receiving_details($rrID, $items_ids = array(), $qtys = array(), $amounts = array())
    {
        /*$result = array_merge($items_ids, $qtys);*/
    ...
    public function addStockCard()
    {
        ...
        $approvedBy = Generic_ajax::updateApprovedBy($this->table, "rrID", $rrID, $this->session->userdata('current_user')->userID);
