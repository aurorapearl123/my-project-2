...
class Loan_type extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->table        = 'loan_types';                                                 
        $this->pfield       = $this->data['pfield'] = 'loanTypeID';                                                 
        $this->logfield     = 'code';
        $this->module_path  = 'modules/salary_and_wages/loan_type';           
        $this->data['controller_page']  = $this->controller_page = site_url('loan_type');
    ...
    private function submenu()
    {
        ...
        $this->data['current_module']   = $this->modules[$this->module]['sub']['Loan Type'];      // defines the current sub module
        // check roles
        $this->check_roles();
    ...
    public function save()
    {
        ...
        $this->submenu();
        $data = $this->data;
        $table_fields = array('code','name','abbr','isTaxable','remarks','status');
