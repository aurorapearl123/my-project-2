...
class Premium extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->table        = 'premiums';                                                 
        $this->pfield       = $this->data['pfield'] = 'premiumID';                                                 
        $this->logfield     = 'code';
        $this->module_path  = 'modules/salary_and_wages/premium';           
        $this->data['controller_page']  = $this->controller_page = site_url('premium');
    ...
    private function submenu()
    {
        ...
        $this->data['current_module']   = $this->modules[$this->module]['sub']['Premium'];      // defines the current sub module
        // check roles
        $this->check_roles();
    ...
    public function save()
    {
        ...
        $this->submenu();
        $data = $this->data;
        $table_fields = array('code','name','abbr','isTaxable','isBasic','idNo','remarks','status');
