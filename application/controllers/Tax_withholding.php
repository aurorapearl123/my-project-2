...
class Tax_withholding extends CI_Controller
{
    //Default Variables
    var $menu;
    var $roles;
    ...
    public function __construct()
    {
        ...
        $this->table        = 'tax_withholding';                                                 
        $this->pfield       = $this->data['pfield'] = 'payID';                                                 
        $this->logfield     = 'empID';
        $this->module_path  = 'modules/salary_and_wages/tax_withholding';           
        $this->data['controller_page']  = $this->controller_page = site_url('tax_withholding');
    ...
    private function submenu()
    {
        ...
        $this->data['current_module']   = $this->modules[$this->module]['sub']['Withholding Tax'];      // defines the current sub module
        // check roles
        $this->check_roles();
    ...
    public function save()
    {
        ...
        $this->submenu();
        $data = $this->data;
        $table_fields = array('employmentID','amount','remarks');
        ...
        if ($this->roles['create']) {
            ...
            if (!empty($employment)) {
                ...
                $this->records->fields['empID']  = $employment->empID;
    ...
    public function update()
    {
        ...
        $this->submenu();
        $data = $this->data;
        $table_fields = array('amount','remarks','status');
    ...
    public function show()
    {
        ...
        $condition_fields = array(
			...
			array('variable'=>'isAutomatic', 'field'=>$this->table.'.isAutomatic', 'default_value'=>'', 'operator'=>'where'),
