...
class Organization extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        // set variables
        $this->data['current_module'] = $this->module = 'Organization';
        $this->module_label = 'Organizations';
        $this->table        = 'employee_organizations';
        $this->module_path  = 'modules/Employee/Organization';
        $this->module_path_submenu  = 'modules/Employee/submenu';
        $this->pfield = 'organizationID';
        $this->logfield = 'organization';
        $this->data['controller_page'] = $this->controller_page = site_url('organization');
    ...
    public function create()
    {
        ...
        if ($this->roles['create']) {
            $data['required_fields'] = array('empID'=>'Employee', 'organization'=>'Organization','address'=>'Address','startYear'=>'Start');
    ...
    public function save()
    {
        ...
        if ($this->roles['create']) {
            ...
            $table_fields = array('empID', 'organization', 'address','startYear','startMonth','startDay',
    ...
    public function get_organizations()
    {
        ...
        $records = $this->db->get('organizations');
        echo $this->frameworkhelper->get_json_data($records, 'organizationID', 'organization');
    }
