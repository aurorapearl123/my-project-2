...
class Work_volunteer extends CI_Controller
{
    //Default Variables
    var $common_menu;
    var $roles;
    ...
    public function __construct()
    {
        ...
        // set variables
        $this->data['current_module'] = $this->module = 'Volunteer Work';
        $this->module_label = 'Volunteer Works';
        $this->table        = 'employee_work_volunteers';
        $this->module_path  = 'modules/Employee/Work_Volunteer';
        $this->module_path_submenu  = 'modules/Employee/submenu';
        $this->pfield = 'volunteerID';
        $this->logfield = 'organization';
        $this->data['controller_page'] = $this->controller_page = site_url('work_volunteer');
    ...
    public function create()
    {
        ...
        if ($this->roles['create']) {
            $data['required_fields'] = array('empID'=>'Employee', 'organization'=>'Organization','address'=>'Address','designation'=>'Designation','startYear'=>'Start');
    ...
    public function save()
    {
        ...
        if ($this->roles['create']) {
            ...
            $table_fields = array('empID', 'organization', 'address', 'designation', 'natureWork','noHours','startYear','startMonth','startDay',
              'endYear','endMonth','endDay','remarks');
            ...
            if ($this->record->save()) {
                ...
                $this->record->where['address']     = trim($this->input->post('address'));
                $this->record->where['designation'] = trim($this->input->post('designation'));
                $this->record->where['startYear']   = trim($this->input->post('startYear'));
    ...
    public function get_work_volunteers()
    {
        $this->db->order_by('organization','asc');
        $records = $this->db->get('work_volunteers');
        echo $this->frameworkhelper->get_json_data($records, 'volunteerID', 'organization');
    }
