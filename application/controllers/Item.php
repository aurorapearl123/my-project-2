...
class Item extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->module_path  = 'modules/'.strtolower(str_replace(" ","_",$this->module)).'/items';// defines module path / folder name
    ...
    private function submenu()
    {
        ...
        $this->data['current_module']        = $this->modules[$this->module]['sub']['Items'];      // defines the current sub module
        // check roles
        $this->check_roles();
    ...
    public function save()
    {
        ...
        $this->submenu();
        $data = $this->data;
        $table_fields = array('brand','item','description','umsr');
        ...
        if ($this->roles['create']) {
            ...
            if ($this->record->save()) {
                ...
                $itemID = $this->record->where['itemID'] = $this->db->insert_id();
                ...
                foreach($branches as $key => $branch){
                    ...
                    $data[$key] = array(
                     ...
                     $this->db->insert_batch('item_inventory', $data[$key]); 
                ...
                $data["urlredirect"] = $this->controller_page."/view/".$this->encrypter->encode($itemID);
                $this->load->view("header",$data);
                $this->load->view("message");
                $this->load->view("footer");
    ...
    public function edit($id)
    {
        ...
        if ($this->roles['edit']) {
            ...
            $this->record->fields[] = 'item_inventory.qty';               
            // set joins
            $this->record->joins[]  = array('item_inventory',$this->table.'.itemID=item_inventory.itemID','left');
            // set where
            $this->record->where['item_inventory.itemID'] = $id;
            $this->record->where['item_inventory.branchID'] = $userCurrentBranch;
    ...
    public function update()
    {
        ...
        $this->submenu();
        $data = $this->data;
        $table_fields = array('brand','item','description','umsr','status');
    ...
    public function show() {
        ...
        $condition_fields = array (
            ...
            array ('variable' => 'item', 'field' => $this->table . '.item', 'default_value' => '', 'operator' => 'like_both' ), 
    ...
    public function check_duplicate()
    {
        ...
        $this->db->where('item', trim($this->input->post('item')));      
