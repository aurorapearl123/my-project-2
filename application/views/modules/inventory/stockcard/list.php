								...
								<table class="table table-striped has-img hover">
									<thead>
										<tr>
											<?php 
												$headers = array(
												    ...
												    array('column_header'=>'item','column_field'=>'remark','width'=>'w-10','align'=>''),
												    array('column_header'=>'Reference no','column_field'=>'conductedBy','width'=>'w-15','align'=>''),
												    array('column_header'=>'Beginning Balance','column_field'=>'createdBy','width'=>'w-15','align'=>''),
												    array('column_header'=>'End Balance','column_field'=>'status','width'=>'w-5','align'=>'center'),
                                                    array('column_header'=>'Debit','column_field'=>'status','width'=>'w-5','align'=>'center'),
                                                    array('column_header'=>'Credit','column_field'=>'status','width'=>'w-5','align'=>'center'),
												);
										...
										<tr id="filter-group" class="collapse multi-collapse table-filter show">
											...
											<th class="form-group form-input">
												<input type="text" class="form-control" id="remark" name="remark" style="width:150px" value="<?php echo $remark ?>">
											</th>
											<th class="form-group form-input">
												<input type="text" class="form-control" id="conductedBy" name="conductedBy" style="width:250px" value="<?php echo $conductedBy ?>">
											</th>
											<th class="form-group form-input">
												<input type="text" class="form-control" id="createdBy" name="createdBy" style="width:250px" value="<?php echo $companyAddress ?>">
											</th>
                                            <th class="form-group form-input">
                                                <input type="text" class="form-control" id="begBalance" name="begBalance" style="width:250px" value="<?php echo $conductedBy ?>">
                                            </th>
                                            <th class="form-group form-input">
                                                <input type="text" class="form-control" id="endBal" name="endBal" style="width:250px" value="<?php echo $companyAddress ?>">
                                            </th>
											<th>
