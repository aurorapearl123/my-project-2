					...
					<div class="card-head">
						...
						<div class="card-head-tools">
							<ul class="tools-list">
								...
								<li>
									<button type="button" class="btn btn-outline-light bmd-btn-icon" data-toggle="tooltip" data-placement="bottom" title="Print" onclick="popUp('<?php echo site_url('item_inventory/printlist') ?>', 800, 500)"><i class="la la-print"></i></button>
								</li>
								<li>
									<button type="button" class="btn btn-outline-light bmd-btn-icon" data-toggle="tooltip" data-placement="bottom" title="Export to Excel File" onclick="window.location='<?php echo site_url('item_inventory/exportlist') ?>';"><i class="la la-file-excel-o"></i></button>
								</li>
							</ul>
						</div>
					</div>
										...
										<tr class="thead-light">
											<?php 
												if($this->session->userdata('current_user')->isAdmin){
													$headers = array(
													    array('column_header'=>'Branch','column_field'=>'branchName','width'=>'w-20','align'=>''),
													    array('column_header'=>'Brand','column_field'=>'brand','width'=>'w-20','align'=>''),
													    array('column_header'=>'Item','column_field'=>'item','width'=>'w-20','align'=>''),
													    ...
													    array('column_header'=>'Reorder Level','column_field'=>'reorderlvl','width'=>'w-5','align'=>'')	
													);
												}else{
									...
									<tbody>
										<?php 
											if (count($records)) {
											    ...
											    ?>
										<tr onclick="location.href='<?php echo $controller_page."/view/".$this->encrypter->encode($row->invID); ?>'">
