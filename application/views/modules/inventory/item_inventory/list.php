								...
								<table class="table table-striped has-img hover">
									<thead>
										<tr>
											<?php 
												$headers = array(
												    array('column_header'=>'Company Code','column_field'=>'companyCode','width'=>'w-5','align'=>''),
												    array('column_header'=>'Company Name','column_field'=>'companyName','width'=>'w-10','align'=>''),
												    array('column_header'=>'Email','column_field'=>'companyEmail','width'=>'w-10','align'=>''),
												    array('column_header'=>'Address','column_field'=>'companyAddress','width'=>'w-15','align'=>''),
												    array('column_header'=>'Head','column_field'=>'companyHeadID','width'=>'w-15','align'=>''),
										...
										<tr id="filter-group" class="collapse multi-collapse table-filter show">
											<th class="form-group form-input">
												<input type="text" class="form-control" id="companyCode" name="companyCode" style="width:150px" value="<?php echo $companyCode ?>">
											</th>
											<th class="form-group form-input">
												<input type="text" class="form-control" id="companyName" name="companyName" style="width:150px" value="<?php echo $companyName ?>">
											</th>
											<th class="form-group form-input">
												<input type="text" class="form-control" id="companyEmail" name="companyEmail" style="width:150px" value="<?php echo $companyEmail ?>">
											</th>
											<th class="form-group form-input">
												<input type="text" class="form-control" id="companyAddress" name="companyAddress" style="width:250px" value="<?php echo $companyAddress ?>">
											</th>
											<th class="form-group form-input">
												<?php 
													...
													?>
												<select class="form-control" id="companyHeadID" name="companyHeadID" data-live-search="true" livesearchnormalize="true" style="width:200px">
													<option value="">&nbsp;</option>
													<?php foreach($heads as $row) {?>
													<option value="<?php echo $row->empID ?>" <?php if($companyHeadID == $row->empID){ echo "selected";}?>><?php echo $row->lname.", ".$row->fname." ".$row->mname ?></option>
													<?php } ?>
												</select>
											</th>
											<th>
									...
									<tbody>
										<?php 
											if (count($records)) {
											    ...
											    ?>
										<tr onclick="location.href='<?php echo $controller_page."/view/".$this->encrypter->encode($row->companyID); ?>'">
