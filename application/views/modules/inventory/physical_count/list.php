								...
								<table class="table table-striped has-img hover">
										...
										<tr>
											<?php 
												$headers = array(
												    ...
												    array('column_header'=>'Remark','column_field'=>'remark','width'=>'w-10','align'=>''),
												    array('column_header'=>'Conducted By','column_field'=>'conductedBy','width'=>'w-15','align'=>''),
												    array('column_header'=>'Crated By','column_field'=>'createdBy','width'=>'w-15','align'=>''),
									...
									<tbody>
										...
										<tr onclick="location.href='<?php echo $controller_page."/view/".$this->encrypter->encode($row->pcID); ?>'">
											...
											<td>
										     <?php  $this->db->select('users.firstName');
										      		$this->db->select('users.middleName');
										      		$this->db->select('users.lastName');
										     		$this->db->where('userID', $row->pcID);										 
