									...
									<thead>
										<tr class="thead-light">
											<?php 
												...
												$headers = array(
												    array('column_header'=>'Reference No','column_field'=>'referenceNo','width'=>'w-10','align'=>''),
												    ...
												    array('column_header'=>'Supplier','column_field'=>'name','width'=>'w-20','align'=>''),
												    array('column_header'=>'Total Qty','column_field'=>'ttlQty','width'=>'w-10','align'=>''),
												    array('column_header'=>'Total Amount','column_field'=>'ttlAmount','width'=>'w-10','align'=>''),
												...
												$headers = array(
												    array('column_header'=>'RR No','column_field'=>'rrNo','width'=>'w-10','align'=>''),
												    array('column_header'=>'Date','column_field'=>'date','width'=>'w-15','align'=>''),
												    array('column_header'=>'Supplier','column_field'=>'name','width'=>'w-20','align'=>''),
												    array('column_header'=>'Total Qty','column_field'=>'ttlQty','width'=>'w-10','align'=>''),
												    array('column_header'=>'Total Amount','column_field'=>'ttlAmount','width'=>'w-10','align'=>''),
									...
									<tbody id="rr-table-body">
										<?php 
											if (count($records)) {
											    ...
											    ?>
										<tr onclick="location.href='<?php echo $controller_page."/view/".$row->rrID; ?>'">
        ...
        $project.data( "ui-autocomplete" )._renderItem = function( ul, item ) {
            ...
            $li.find('a').append($img)
                .append($('<span >').attr('class', 'result-search').text(item.value)
                    ...
                    .append($('<br>'))
                    //.append($('<span style="font-size: 0.7em;">').text(item.date))
                    .append($('<span style="font-size: 0.7em;">').text("Total amount : "+item.total_amount)
                    )
                );
