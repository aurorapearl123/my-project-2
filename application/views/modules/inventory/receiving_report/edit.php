					...
					<form method="post" name="frmEntry" id="frmEntry" action="<?php echo site_url('receiving_report/update') ?>">
                        ...
                        <div class="table-row mt-20">
                            <table class="table-form">
                                <tbody>
                                    <tr>
                                        <td class="form-label text-right" width="37%" nowrap>
                                            <label for="config">Total :</label>
                                        </td>

                                        <td class="form-group form-input" width="11%">

                                            <input type="text" class="form-control" name="ttlQty" id="ttlQty" title="Total Qty" value="<?php echo $rec->ttlQty?>" required readonly>
                                        </td>
                                        <td class="form-group form-input" width="11%">
                                            <input type="text" class="form-control" name="ttlAmount" id="ttlAmount" title="Total Amount" value="<?php echo $rec->ttlAmount?>" required readonly>
                                        </td>
                                        <td></td>
                                        <td class="d-xxl-none"></td>
                                    </tr>
