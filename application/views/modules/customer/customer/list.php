								...
								<table class="table table-striped has-img hover">
									<thead>
										<tr>
											<?php 
												$headers = array(
                                                    array('column_header'=>'Title','column_field'=>'title','width'=>'w-5','align'=>''),
                                                    array('column_header'=>'Suffix','column_field'=>'suffix','width'=>'w-5','align'=>''),
                                                    array('column_header'=>'First Name','column_field'=>'fname','width'=>'w-5','align'=>''),
                                                    array('column_header'=>'Middle Name','column_field'=>'mname','width'=>'w-5','align'=>''),
                                                    array('column_header'=>'Last Name','column_field'=>'lname','width'=>'w-5','align'=>''),
                                                    array('column_header'=>'Mobile','column_field'=>'mobile','width'=>'w-5','align'=>''),
                                                    array('column_header'=>'Status','column_field'=>'status','width'=>'w-5','align'=>''),
												);
										...
										<tr id="filter-group" class="collapse multi-collapse table-filter show">
											<th class="form-group form-input">
												<input type="text" class="form-control" id="title" name="title" style="width:150px" value="<?php echo $title ?>">
											</th>
											<th class="form-group form-input">
											...
											<th class="form-group form-input">
												<input type="text" class="form-control" id="suffix" name="suffix" style="width:100px" value="<?php echo $suffix ?>">
											</th>
											<th class="form-group form-input">
                                                <input type="text" class="form-control" id="telephone" name="telephone" style="width:100px" value="<?php echo $telephone ?>">
											</th>
                                            <th class="form-group form-input">
                                                <input type="text" class="form-control" id="mobile" name="mobile" style="width:100px" value="<?php echo $mobile ?>">
                                            </th>
                                            <th class="form-group form-input">
                                                <input type="text" class="form-control" id="status" name="status" style="width:100px" value="<?php echo $status ?>">
                                            </th>
										</tr>
									</thead>
									<tbody>
