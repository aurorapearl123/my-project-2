        ...
        <div class="card-head">
          <div class="head-caption">
            <div class="head-title">
              <h4 class="head-text">Promote <?php echo $current_module['module_label'] ?></h4>
            </div>
          </div>
          <div class="card-head-tools"></div>
        </div>
        <div class="card-body">
          <form method="post" name="frmEntry" id="frmEntry" action="<?php echo $controller_page ?>/promote" >
            ...
            <table class="table-form column-3">
              <tbody>
                ...
                <tr>
                  <td class="form-label">
                    Date Promoted<span class="asterisk">*</span>
                  </td>
