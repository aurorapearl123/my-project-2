        ...
        <div class="card-head">
          <div class="head-caption">
            <div class="head-title">
              <h4 class="head-text">Demote <?php echo $current_module['module_label'] ?></h4>
            </div>
          </div>
          <div class="card-head-tools"></div>
        </div>
        <div class="card-body">
          <form method="post" name="frmEntry" id="frmEntry" action="<?php echo $controller_page ?>/demote" >
            ...
            <table class="table-form column-3">
              <tbody>
                ...
                <tr>
                  <td class="form-label">
                    Date Demoted<span class="asterisk">*</span>
                  </td>
