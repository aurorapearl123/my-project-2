                        ...
                        <table class="table table-striped hover">
                          <thead>
                            ...
                            <tr id="filter-group" class="collapse multi-collapse table-filter show">
                              ...
                              <th class="form-group form-input">
                                <input type="text" class="form-control" id="lname" name="lname" style="width:100px" value="<?php echo $lname ?>">
                              </th>
                              <th class="form-group form-input">
                                <input type="text" class="form-control" id="fname" name="fname" style="width:100px" value="<?php echo $fname ?>">
                              </th>
                              <th class="form-group form-input">
                                <input type="text" class="form-control" id="mname" name="mname" style="width:100px" value="<?php echo $mname ?>">
                              </th>
                              <th class="form-group form-input">
                              </th>
                              <th class="form-group form-input">
                              ...
                              <th class="form-group form-input">
                                 <select class="form-control" id="civilStatus" name="civilStatus" style="width:50px">
                                  <option value="">&nbsp;</option>
