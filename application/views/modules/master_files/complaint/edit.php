							...
							<table class="table-form column-3" >
								<tbody>
									<tr>
										...
										<td class="form-label" width="200" nowrap>Date of Complaint <span class="asterisk">*</span></td>
										<td class="form-group data-input" align=""  valign="top" nowrap>
											<input type="text" class="form-control datepicker" id="date" name="date" data-toggle="datetimepicker" value="<?php echo date('M d, Y',strtotime($rec->date))?>" data-target="#date" title="Date of Complain" style="width:350px" required>
										</td>
										<td class="d-xxl-none" ></td>
									</tr>
									<tr>
										<td class="form-label" style="width:100px" nowrap>Customer <span class="asterisk">*</span></td>
										<td class="form-group form-input" nowrap>
											<?php 
												$this->db->where('status',1);
												$recs = $this->db->get('customers')->result();
												?>
											<select class="form-control" id="custID" name="custID" data-live-search="true" livesearchnormalize="true" style="width:200px" title="-Select Customer-" onchange="get_orders()">
												<?php foreach($recs as $res) {?>
									...
									<tr>
										<td class="form-label" style="" nowrap>Complaint <span class="asterisk">*</span></td>
										<td class="form-group form-input" style="" nowrap>											
									...
									<tr>
										<td class="form-label" style="" nowrap>Contact No <span class="asterisk">*</span></td>
										<td class="form-group form-input" style="" nowrap>
