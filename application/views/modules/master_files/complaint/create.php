					...
					<form method="post" name="frmEntry" id="frmEntry" action="<?php echo site_url("complaint/save") ?>">
						<div class="table-row">
							<table class="table-form column-3">
								<tbody>
									<tr>
										<td class="form-label" width="120" nowrap>Branch <span class="asterisk">*</span></td>
										...
										<td class="form-group data-input" align=""  valign="top" nowrap>
											<input type="text" class="form-control datepicker" id="date" name="date" data-toggle="datetimepicker" value="" data-target="#date" title="Date of Complain" style="width:350px" required>
										</td>
