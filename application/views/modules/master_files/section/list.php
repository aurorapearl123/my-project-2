					...
					<div class="card-head">
						...
						<div class="card-head-tools">
							<ul class="tools-list">
								...
								<li>
									<button type="button" class="btn btn-outline-light bmd-btn-icon" data-toggle="tooltip" data-placement="bottom" title="Print" onclick="popUp('<?php echo site_url('section/printlist') ?>', 800, 500)"><i class="la la-print"></i></button>
								</li>
								<li>
									<button type="button" class="btn btn-outline-light bmd-btn-icon" data-toggle="tooltip" data-placement="bottom" title="Export to Excel File" onclick="window.location='<?php echo site_url('section/exportlist') ?>';"><i class="la la-file-excel-o"></i></button>
								</li>
							</ul>
						</div>
					</div>
								...
								<table class="table table-striped has-img hover">
									<thead>
										<tr>
											<?php 
												$headers = array(
												    array('column_header'=>'Code','column_field'=>'divisionCode','width'=>'w-5','align'=>''),
												    array('column_header'=>'Section Name','column_field'=>'divisionName','width'=>'w-10','align'=>''),
												    array('column_header'=>'Branch','column_field'=>'branchID','width'=>'w-10','align'=>''),
												    array('column_header'=>'Department','column_field'=>'deptID','width'=>'w-10','align'=>''),
												    array('column_header'=>'Email','column_field'=>'divisionEmail','width'=>'w-10','align'=>''),
												    array('column_header'=>'Head','column_field'=>'divisionHeadID','width'=>'w-15','align'=>''),
										...
										<tr id="filter-group" class="collapse multi-collapse table-filter show">
											<th class="form-group form-input">
												<input type="text" class="form-control" id="divisionCode" name="divisionCode" style="width:150px" value="<?php echo $divisionCode ?>">
											</th>
											<th class="form-group form-input">
												<input type="text" class="form-control" id="divisionName" name="divisionName" style="width:150px" value="<?php echo $divisionName ?>">
											</th>
											<th class="form-group form-input">
												<select id="branchID" name="branchID" class="form-control" onchange="get_departments();">
													<option value="">&nbsp;</option>
													<?php 
											...
											<th class="form-group form-input">
												<select id="deptID" name="deptID" class="form-control">
													...
													<?php 
														...
														foreach ($results as $res) {
														?>
													<option value="<?php echo $res->deptID ?>" <?php if ($res->deptID == $deptID) { echo "selected"; } ?> onchange="get_branches();"><?php echo $res->deptCode ?></option>
													<?php } ?>
												</select>
											</th>
											<th class="form-group form-input">
												<input type="text" class="form-control" id="divisionEmail" name="divisionEmail" value="<?php echo $divisionEmail?>" style="width:150px">
											</th>
											<th class="form-group form-input">
												<?php 
													...
													?>
												<select class="form-control" id="divisionHeadID" name="divisionHeadID" data-live-search="true" livesearchNormalize="true">
													<option value="" selected>&nbsp;</option>
													<?php foreach($heads as $row) {?>
													<option value="<?php echo $row->empID ?>" <?php if ($row->empID == $divisionHeadID) { echo "selected"; } ?>><?php echo $row->lname.", ".$row->fname." ".$row->mname ?></option>
													<?php } ?>
												</select>
											</th>
											<th>
									...
									<tbody>
										...
										<tr onclick="location.href='<?php echo $controller_page."/view/".$this->encrypter->encode($row->divisionID); ?>'">
											...
											<td><?php echo $row->divisionEmail ?></td>
