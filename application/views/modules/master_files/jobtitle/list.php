					...
					<div class="card-head">
						...
						<div class="card-head-tools">
							<ul class="tools-list">
								...
								<li>
									<button type="button" class="btn btn-outline-light bmd-btn-icon" data-toggle="tooltip" data-placement="bottom" title="Print" onclick="popUp('<?php echo site_url('jobtitle/printlist') ?>', 800, 500)"><i class="la la-print"></i></button>
								</li>
								<li>
									<button type="button" class="btn btn-outline-light bmd-btn-icon" data-toggle="tooltip" data-placement="bottom" title="Export to Excel File" onclick="window.location='<?php echo site_url('jobtitle/exportlist') ?>';"><i class="la la-file-excel-o"></i></button>
								</li>
							</ul>
						</div>
					</div>
								...
								<table class="table table-striped has-img hover">
									<thead>
										<tr>
											<?php 
												$headers = array(
												    array('column_header'=>'Code','column_field'=>'code','width'=>'w-5','align'=>''),
												    array('column_header'=>'Job Title','column_field'=>'jobtitle','width'=>'w-20','align'=>''),
												    array('column_header'=>'Description','column_field'=>'jobDescription','width'=>'w-25','align'=>''),
										...
										<tr id="filter-group" class="collapse multi-collapse table-filter show">
											<th class="form-group form-input">
												<input type="text" class="form-control" id="code" name="code" style="width:100px" value="<?php echo $code ?>">
											</th>
											<th class="form-group form-input">
												<input type="text" class="form-control" id="jobTitle" name="jobTitle" style="width:300px" value="<?php echo $jobTitle ?>">
											</th>
											<th class="form-group form-input">
												<input type="text" class="form-control" id="jobDescription" name="jobDescription" style="width:350px" value="<?php echo $jobDescription ?>">
											</th>
											<th>
									...
									<tbody>
										<?php 
											if (count($records)) {
											    ...
											    ?>
										<tr onclick="location.href='<?php echo $controller_page."/view/".$this->encrypter->encode($row->jobTitleID); ?>'">
