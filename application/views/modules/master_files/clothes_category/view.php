<div class="subheader">
	<div class="d-flex align-items-center">
		...
		<div class="subheader-tools">
			<a href="<?php echo site_url('clothes_category/show') ?>" class="btn btn-primary btn-raised btn-xs pill"><i class="icon ti-angle-left"></i> Back to List</a>
		</div>
	</div>
</div>
<div class="content">
				...
				<div class="card-body">
					<div class="data-view">
						<table class="view-table">
							<tbody>
								<tr>
									<td class="data-title" width="120" nowrap>Category:</td>
									<td class="data-input"><?php echo $rec->category; ?></td>
