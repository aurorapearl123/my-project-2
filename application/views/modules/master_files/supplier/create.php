								...
								<tbody>
									<tr>
										...
										<td class="form-group form-input">
											<input type="text" class="form-control" name="name" id="name" title="Supplier Name" required>
										</td>
									...
									<tr>
										...
										<td class="form-group form-input">
											<input type="text" class="form-control" name="contactNo" id="contactNo" title="Contact Number" required>
