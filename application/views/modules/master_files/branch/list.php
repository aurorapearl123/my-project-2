								...
								<table class="table table-striped has-img hover">
									<thead>
										<tr>
											<?php 
												$headers = array(
												    array('column_header'=>'Branch Code','column_field'=>'branchCode','width'=>'w-5','align'=>''),
												    ...
												    array('column_header'=>'Head','column_field'=>'branchHeadID','width'=>'w-15','align'=>''),
										...
										<tr id="filter-group" class="collapse multi-collapse table-filter show">
											<th class="form-group form-input">
												<input type="text" class="form-control" id=branchCode name="branchCode" value="<?php echo $branchCode ?>">
											</th>
											<th class="form-group form-input">
											...
											<th class="form-group form-input">
												<input type="text" class="form-control" id="branchEmail" name="branchEmail" style="width:200px" value="<?php echo $branchEmail ?>">
											</th>
											<th class="form-group form-input">
												<input type="text" class="form-control" id="branchAddress" name="branchAddress" style="width:200px" value="<?php echo $branchAddress ?>">
											</th>
											<th class="form-group form-input" nowrap>
												<?php 
													$this->db->where('status',1);
													$heads = $this->db->get('employees')->result();
													?>
												<select class="form-control" id="branchHeadID" name="branchHeadID" data-live-search="true" livesearchnormalize="true" style="width:300px">
													<option value="">&nbsp;</option>
