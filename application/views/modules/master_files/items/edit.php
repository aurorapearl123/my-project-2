	...
	<div class="row">
		<div class="col-12">
			<div class="card-box">
				...
				<div class="card-body">
					<form method="post" name="frmEntry" id="frmEntry" action="<?php echo site_url('item/update') ?>">
						<input type="hidden" name="itemID" id="itemID" value="<?php echo $this->encrypter->encode($rec->itemID) ?>" />
						<div class="table-row">
